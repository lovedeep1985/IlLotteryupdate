...
export default class TimerComponent extends Component<Props> {
  ...
  render() {
    let getLotteryDay = new Date(this.props.nextLotteryTime).getDate(),
        getLotteryHour =  new Date(this.props.nextLotteryTime).getHours(),
        getLotteryMinutes = new Date(this.props.nextLotteryTime).getMinutes(),
        getLotterySeconds = new Date(this.props.nextLotteryTime).getSeconds();
    return (
